...
const static nlohmann::json atFunctions = nlohmann::json::array({
  {
    {"label", "call"},
  ...
  {
    {"label", "output"},
    {"detail", "Print a list of characters to the a file descriptor."},
    {"kind", 3},
    {"documentation", "This function prints each of its inputs to the file descriptor by converting to a string and writing to a file descriptor.\nThis function is helpful when writing to files, debugging, or asking for user input.\nIf you want to print to the console, the file descriptor of stdout is `1`.\nAccepted types include:\n\n- int\n- char\n- *char\n- []char\n- str\n- bool"}
  },
  {
    {"label", "outputln"},
    {"detail", "Print a list of characters to a file descriptor, appended with a newline (\\n)"},
    {"kind", 3},
    {"documentation", "This function prints each of its inputs to the file descriptor by converting to a string and writing to a file descriptor. @outputln, as opposed to @output, will automatically write a '\\n' to your output. It's the same thing as doing `@output(1, \"Hello, World\", \"\\n\")`.\nThis function is helpful when writing to files, debugging, or asking for user input.\nIf you want to print to the console, the file descriptor of stdout is `1`.\nAccepted types include:\n\n- int\n- char\n- *char\n- []char\n- str\n- bool"}
  },
  {
    {"label", "input"},
